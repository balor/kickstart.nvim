...
-- Diagnostic keymaps
-- Commented as using Trouble instead
...
-- source: https://github.com/LazyVim/LazyVim/blob/25abbf546d564dc484cf903804661ba12de45507/lua/lazyvim/config/autocmds.lua#L9
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- TODO: Pack the mason into if else by detecting if this is NIX OS
    ...
    config = function()
      ...
      require('mini.surround').setup({
        mappings = {
          ...
          find = '',           -- Optional: disable if unused
          find_left = '',      -- Optional: disable if unused
          highlight = '',      -- Optional: disable if unused
          replace = 'gsr',     -- Replace surrounding
          update_n_lines = '', -- Optional: disable if unused
        }
      })
